...
public class QuizController {
    ...
    public ResponseEntity<Object> getQuizVocabularies(@PathVariable("categoryId") String categoryId,
                                                      @RequestParam(value = "rankLV", defaultValue = "") String rankLV,
                                                      @RequestParam(value = "wordNum", defaultValue = "") String wordNum) {
        List<Vocabulary> vocabulary = quizService.getQuizVocabularies(categoryId, rankLV, wordNum);
