...
public class QuizService {
    ...
    public List<Vocabulary> getQuizVocabularies(String email, String categoryId, String rankLV, String wordNum) {
        List<Vocabulary> vocabularyList;
        if (rankLV.equals(""))    // 無指定LV -> 所有單字
            vocabularyList = vocabularyService.getAllVocabularies(email, categoryId);
        else {
            int rank = Integer.parseInt(rankLV);
            vocabularyList = vocabularyService.getVocabulariesByRankLV(email, categoryId, rank);
        }
