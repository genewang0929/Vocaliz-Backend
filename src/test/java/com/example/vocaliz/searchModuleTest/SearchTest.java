...
public class SearchTest {
    ...
    public void testSearchVocabulary() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.vocabulary.items.[0].parentCategoryId").value(category.getCategoryId()))
                .andExpect(jsonPath("$.vocabulary.items.[0].parentCategoryName").value(category.getCategoryName()))
                ...
                .andExpect(jsonPath("$.vocabulary.items.[1].parentCategoryId").value(category.getCategoryId()))
                .andExpect(jsonPath("$.vocabulary.items.[1].parentCategoryName").value(category.getCategoryName()))
