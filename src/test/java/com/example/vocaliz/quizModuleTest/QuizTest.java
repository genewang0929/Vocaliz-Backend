package com.example.vocaliz.quizModuleTest;
...
public class QuizTest {
    ...
    @Test
    public void testGetQuizVocabularies() throws Exception {
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.vocabulary.[0].vocabularyId").hasJsonPath())
                .andExpect(jsonPath("$.vocabulary.[0].word").value(request_1.getWord()))
                .andExpect(jsonPath("$.vocabulary.[0].definition").value(request_1.getDefinition()))
    ...
    public Vocabulary createVocabularyWithLV(String email, String categoryId, Vocabulary vocabulary) {
